...
public class Board implements BoardManager {
    ...
    public int getEntryPosition(Colour colour) {
    ...
    public int getTrackPosition(Marble marble) {
        return getPositionInPath(track, marble);
    }

    public SafeZone getSafeZoneByColour(Colour colour) {
    ...
    public int getSafeZonePosition(Marble marble) {
        SafeZone zone = getSafeZoneByColour(marble.getColour());
        if (zone == null) {
            return -1;
        }
        return getPositionInPath(zone.getCells(), marble);
    }
